...
router.get('/coupons', authorize(['admin']), adminController.listCoupons);
router.post('/coupons', authorize(['admin']), adminController.createCoupon);
router.patch('/coupons/:id', authorize(['admin']), adminController.updateCoupon);
